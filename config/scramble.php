...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'Helpdesk identification: client self-service (session cookie or Sanctum bearer token), mobile sign-in, the call-center / IVR integration and the mobile app backend contract. Separate documents: /docs/ivr and /docs/mobile.',
    ],
